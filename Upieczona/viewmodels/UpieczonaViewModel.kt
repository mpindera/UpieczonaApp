...
/*    fun fetchRecipe(content: String): List<String> {
    ...
    fun fetchRecipe(content: String): List<String> {
        ...
        val paragraphContents = mutableListOf<String>()
        for (match in matches) {
            val paragraphText = match.replace("""<[^>]+>""".toRegex(), "")
            paragraphContents.add(paragraphText.trim())
        }
